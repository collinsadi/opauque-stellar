...
import { RecoveryManager, type BackupPayload } from "../../services/recoveryManager";
    ...
    <div className="bg-ink-900 p-6 rounded-lg shadow-md border border-ink-700">
      ...
      <form onSubmit={handleExport} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-neutral-600 text-white font-bold py-2 px-4 rounded hover:bg-neutral-700 transition disabled:bg-neutral-400"
        >
